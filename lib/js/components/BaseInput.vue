<template>
    <div style="position: relative; display: flex; align-items: center">
        ...
        <div style="position: relative;">
            ...
            >
            <!--            <Icon-->
            <!--                v-visible="hasError && showErrorIcon && !hideErrorLabel"-->
            <!--                name="icon-error"-->
            <!--                class="icon-error"-->
            <!--                color="#DD3D3D"-->
            <!--            />-->
...
import visible from "/lib/js/directives/visible";
...
<style lang="sass" scoped>
    ...
    @import 'lib/css/src/partials/geometrics'
    @import 'lib/css/src/mixins/setTypography.mixin.sass'
    @import 'lib/css/src/mixins/visuals.mixin.sass'
